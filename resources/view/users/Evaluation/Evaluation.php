...
<div class="min-h-screen md:ml-64 p-6 md:p-8">
    ...
    <form id="form-evaluacion" action="/evaluation/guardar" method="POST">
        ...
        <div style="background:white; border-radius:16px; padding:16px 20px; display:flex; justify-content:flex-end; gap:10px; box-shadow:0 1px 4px rgba(0,0,0,0.08);">
            <a href="/tutorias/<?= $tutoria_id ?>/sesiones?numero=1" class="btn btn-outline" style="font-size:13px; padding:7px 18px;">Cancelar</a>            <button type="button" onclick="guardarEvaluacion()" class="btn btn-primary" style="font-size:13px; padding:7px 18px;">
                Guardar evaluación
            </button>
        </div>
    </form>
